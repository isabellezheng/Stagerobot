...
if(NOT "include;/home/firefly/projet/rostest/src/rmc_software/navigation/maskor_navigation/sbpl/include " STREQUAL " ")
  set(sbpl_lattice_planner_INCLUDE_DIRS "")
  set(_include_dirs "include;/home/firefly/projet/rostest/src/rmc_software/navigation/maskor_navigation/sbpl/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sbpl_lattice_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/firefly/projet/rostest/install/${idir}'.  Ask the maintainer 'Dave Hershberger <hersh@willowgarage.com>' to fix it.")
    endif()
