...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/firefly/projet/rostest/install/${idir}'.  Ask the maintainer 'Krystian-L0g1x <krgebis@gmail.com>' to fix it.")
    endif()
