...
if("TRUE" STREQUAL "TRUE")
  set(robot_setup_tf_SOURCE_PREFIX /home/firefly/projet/rostest/src/rmc_software/robot_setup_tf)
  set(robot_setup_tf_DEVEL_PREFIX /home/firefly/projet/rostest/devel)
  ...
  set(robot_setup_tf_INSTALL_PREFIX /home/firefly/projet/rostest/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_setup_tf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Krystian-L0g1x <krgebis@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_setup_tf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/firefly/projet/rostest/src/rmc_software/robot_setup_tf/${idir}'.  Ask the maintainer 'Krystian-L0g1x <krgebis@gmail.com>' to fix it.")
    endif()
