...
if("TRUE" STREQUAL "TRUE")
  set(state_machine_SOURCE_PREFIX /home/firefly/projet/rostest/src/rmc_software/state_machine)
  set(state_machine_DEVEL_PREFIX /home/firefly/projet/rostest/devel)
  ...
  set(state_machine_INSTALL_PREFIX /home/firefly/projet/rostest/install)
...
if(NOT "/home/firefly/projet/rostest/src/rmc_software/state_machine/include " STREQUAL " ")
  set(state_machine_INCLUDE_DIRS "")
  set(_include_dirs "/home/firefly/projet/rostest/src/rmc_software/state_machine/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Krystian-L0g1x <krgebis@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/firefly/projet/rostest/src/rmc_software/state_machine/${idir}'.  Ask the maintainer 'Krystian-L0g1x <krgebis@gmail.com>' to fix it.")
    endif()
...
set(depends "actionlib;geometry_msgs;move_base_msgs;roscpp;tf")
