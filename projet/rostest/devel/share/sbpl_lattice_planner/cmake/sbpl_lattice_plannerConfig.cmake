...
if("TRUE" STREQUAL "TRUE")
  set(sbpl_lattice_planner_SOURCE_PREFIX /home/firefly/projet/rostest/src/rmc_software/navigation/maskor_navigation/sbpl_lattice_planner)
  set(sbpl_lattice_planner_DEVEL_PREFIX /home/firefly/projet/rostest/devel)
  ...
  set(sbpl_lattice_planner_INSTALL_PREFIX /home/firefly/projet/rostest/install)
...
if(NOT "/home/firefly/projet/rostest/devel/include;/home/firefly/projet/rostest/src/rmc_software/navigation/maskor_navigation/sbpl_lattice_planner/include;/home/firefly/projet/rostest/src/rmc_software/navigation/maskor_navigation/sbpl/include " STREQUAL " ")
  set(sbpl_lattice_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/firefly/projet/rostest/devel/include;/home/firefly/projet/rostest/src/rmc_software/navigation/maskor_navigation/sbpl_lattice_planner/include;/home/firefly/projet/rostest/src/rmc_software/navigation/maskor_navigation/sbpl/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'sbpl_lattice_planner' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Dave Hershberger <hersh@willowgarage.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'sbpl_lattice_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/firefly/projet/rostest/src/rmc_software/navigation/maskor_navigation/sbpl_lattice_planner/${idir}'.  Ask the maintainer 'Dave Hershberger <hersh@willowgarage.com>' to fix it.")
    endif()
...
set(sbpl_lattice_planner_EXPORTED_TARGETS "sbpl_lattice_planner_generate_messages_cpp;sbpl_lattice_planner_generate_messages_lisp;sbpl_lattice_planner_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${sbpl_lattice_planner_dep}_FOUND)
      find_package(${sbpl_lattice_planner_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${sbpl_lattice_planner_dep} REQUIRED ${depend_list})
  endif()
  ...
  list(APPEND sbpl_lattice_planner_EXPORTED_TARGETS ${${sbpl_lattice_planner_dep}_EXPORTED_TARGETS})
endforeach()
