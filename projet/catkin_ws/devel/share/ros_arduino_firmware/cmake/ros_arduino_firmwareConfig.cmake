...
if("TRUE" STREQUAL "TRUE")
  set(ros_arduino_firmware_SOURCE_PREFIX /home/firefly/projet/catkin_ws/src/ros_arduino_bridge/ros_arduino_firmware)
  set(ros_arduino_firmware_DEVEL_PREFIX /home/firefly/projet/catkin_ws/devel)
  ...
  set(ros_arduino_firmware_INSTALL_PREFIX /home/firefly/projet/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ros_arduino_firmware' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/firefly/projet/catkin_ws/src/ros_arduino_bridge/ros_arduino_firmware/${idir}'.  Ask the maintainer 'Patrick Goebel <patrick@pirobot.org>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ros_arduino_firmware_dep}_FOUND)
      find_package(${ros_arduino_firmware_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ros_arduino_firmware_dep} REQUIRED ${depend_list})
  endif()
